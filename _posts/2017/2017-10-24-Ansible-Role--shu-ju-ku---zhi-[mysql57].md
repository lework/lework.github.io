---
layout: post
title: "Ansible Role 数据库 之【mysql57】"
date: "2017-10-24 14:31:14"
categories: Ansible
excerpt: "Ansible Role: Mysql 5.7 安装mysql 5.7 介绍 MySQL是一个关系型数据库管理系统，由瑞典MySQL AB 公司..."
auth: lework
---
* content
{:toc}
...
## 附件
提供mysql-boost-5.7.20-bin.tar.gz 文件以供参考
链接：http://pan.baidu.com/s/1eRJtLM6 密码：2qwh

## Example Playbook

    默认安装, 使用bin文件(已编译好的mysql),文件路径/opt/software/mysql-boost-5.7.20-bin.tar.gz)：
    - hosts: node2
      roles:
      - mysql57
